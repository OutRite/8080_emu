...
def test_jumps():
    ...
    memory.write_memory(0x0221, 0b01110110, restricted=False)
    memory.write_memory(0x0222, 0b01110110, restricted=False)
    memory.write_memory(0x2102, 0b01110110, restricted=False)
    memory.write_memory(0x2103, 0b01110110, restricted=False)
    memory.write_memory(0x0003, 0b01110110, restricted=False)
    cpu.boot(0x0000)
...
def test_mvi():
    ...
    memory.write_memory(0x0002, 0b01110110, restricted=False)
    cpu.boot(0x0000)
...
def test_call_ret():
    ...
    memory.write_memory(0x0004, 0b01110110, restricted=False)
    cpu.boot(0x0000)
